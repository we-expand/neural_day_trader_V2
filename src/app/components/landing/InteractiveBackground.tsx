...
export const InteractiveBackground = () => {
  ...
  useEffect(() => {
    ...
    const particleCount = 60; // Not too crowded, delicate
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.vx = (Math.random() - 0.5) * 0.5; // Slow, drift movement
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i; j < particles.length; j++) {
          ...
          if (distance < connectionDistance) {
            ctx.beginPath();
            ctx.strokeStyle = `rgba(148, 163, 184, ${1 - distance / connectionDistance})`; // Slate-400 fade
            ctx.lineWidth = 0.5;
