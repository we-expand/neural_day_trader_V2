...
export const FinancialHUD = memo(function FinancialHUD() {
  ...
  // 🔴 2026-09-08: saldo real (quando broker conectado) é sincronizado num
  // único lugar, dentro do reconcile() de useApexLogic.ts -- ver comentário
  // lá. Um segundo poller aqui (tentativa anterior) competia com aquele e
  // perdia a corrida (5s vs 15s), sempre voltando pro valor simulado.
  // FinancialHUD só EXIBE `portfolio.balance/equity`, não sincroniza nada.
