...
// node_modules/.pnpm/klinecharts@9.8.10/node_modules/klinecharts/dist/index.esm.js
...
var TooltipStore = (
  ...
  (function() {
    ...
    TooltipStore2.prototype.setCrosshair = function(crosshair, notInvalidate) {
      var dataList = this._chartStore.getDataList();
...
var Widget = (
  ...
  (function(_super) {
    ...
    Widget2.prototype.init = function(rootContainer) {
...
var DrawWidget = (
  ...
  (function(_super) {
    ...
    function DrawWidget2() {
      return _super !== null && _super.apply(this, arguments) || this;
    }
    DrawWidget2.prototype.init = function(rootContainer) {
      var _this = this;
      ...
      if (indicator.visible) {
        ...
        eachFigures(dataList, indicator, dataIndex, styles2, function(figure, figureStyles) {
          if (isString(figure.title)) {
            ...
            legends.push({ title: { text: figure.title, color }, value: { text: formatFoldDecimal(formatThousands(value !== null && value !== void 0 ? value : tooltipStyles.defaultValue, thousandsSeparator), decimalFoldThreshold), color } });
          }
        });
        ...
        switch (name_7) {
          case WidgetNameConstants.MAIN: {
            ...
            if (widget.dispatchEvent("mouseDownEvent", event_8)) {
              ...
              this._touchCoordinate = null;
              tooltipStore.setCrosshair(void 0, true);
              this._chart.updatePane(
                1
                /* UpdateLevel.Overlay */
              );
